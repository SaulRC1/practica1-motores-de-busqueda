...
import saul.rodriguez.naranjo.practica1.motores.de.busqueda.ui.trec.*;
...
import saul.rodriguez.naranjo.practica1.motores.de.busqueda.ui.worker.BuildGateTrecTopFileWorker;
 ...
 */
public class BuildTrecTopFileWithGatePanel extends JPanel
{
    ...
    public BuildTrecTopFileWithGatePanel(JFrame parentFrame)
    {
        super();
            ...
            SwingUtilities.invokeLater(() ->
            {
                ...
                if (fileChooser.showSaveDialog(parentFrame) == JFileChooser.APPROVE_OPTION)
                {
                    if (fileChooser.getSelectedFile() != null)
                    {
                        ...
                        BuildGateTrecTopFileWorker worker = new BuildGateTrecTopFileWorker(solrQueries, filePath);
                        ...
                        SwingUtilities.invokeLater(() ->
                        {
                            Thread thread = new Thread(() ->
                            {
                                ...
                                {
                                    Logger.getLogger(BuildTrecTopFileWithGatePanel.class.getName())
