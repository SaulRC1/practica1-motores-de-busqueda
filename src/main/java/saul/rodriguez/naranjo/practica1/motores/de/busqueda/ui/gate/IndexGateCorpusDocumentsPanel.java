 ...
 */
public class IndexGateCorpusDocumentsPanel extends JPanel
{

    private final JFrame parentFrame;

    private GateCorpusDocumentTable corpusDocumentsTable;
    ...
    public IndexGateCorpusDocumentsPanel(JFrame parentFrame, List<SolrInputDocument> solrInputDocuments)
    {
    ...
    {
        corpusDocumentsTable = new GateCorpusDocumentTable(400, 400);
        ...
        indexButton.addActionListener((ActionEvent e) ->
        {
            ...
            SwingUtilities.invokeLater(() ->
            {
                ...
                Thread thread = new Thread(() ->
                {
                    ...
                    {
                        Logger.getLogger(IndexGateCorpusDocumentsPanel.class.getName())
